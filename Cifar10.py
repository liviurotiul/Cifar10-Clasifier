...
class DataManager():
    def __init__(self):
        ...
        self.trainloader = torch.utils.data.DataLoader(self.trainset, batch_size=args.trbs,
                                                  shuffle=True, num_workers=2)

        self.testset = torchvision.datasets.CIFAR10(root='./data', train=False,
                                               download=True, transform=self.transform)
        self.testloader = torch.utils.data.DataLoader(self.testset, batch_size=args.tstbs,
                                                 shuffle=False, num_workers=2)
